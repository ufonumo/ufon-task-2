...
<body>
    ...
    <div class="profile-info">
        ...
        <div class="trip">
            ...
            <p>I was among the co-organizers of several tech meet-ups in 2018 at Bells University Of Technology. <br>
            Most of them are:
                <li>Forloop</li><br>
                <li>Cloud study jam</li><br>
                <li>Mobile certification study jam</li><br>
            </p>
        </div>
        ...
        <div class="trip">
            ...
            <li> Uduaku College - SSCE, NECO 2010-2016</li> <br>
            <li> Bells University of Technology - ongoing B.Tech <br>Surveying and Geoinformatics  2016- Present 
            </li> 
        </div>
    ...
    <div class="form">
            <h2>Contact Me</h2>
            <form action="ufon.php" method="POST">
                <div class="input-group">
                    <input type="text" placeholder="Name" name="" id="name" minlength="4" required> 
                    <input type="email" placeholder="Email" required > 
                    <input type="text" placeholder="Title" required minlength="4" data-="text">
                </div>
                <div class="text-area"  >
                    <textarea name="text" rows="3" minlength="20" required placeholder="Your Message" ></textarea>
                </div>
                <button type="submit" class="submit-btn">SEND MESSAGE</button>
            </form>
    </div>

    <p class="copy">Designed by Ufonabasi</p>    
